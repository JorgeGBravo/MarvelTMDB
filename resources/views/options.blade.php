    ...
    <div id="item" class="flex flex-row">
        ...
        <div id="center" class=" w-3/5 -mt-1">
            <div id="visor" class="justify-between mt-52 bg-customHeader ">
                    ...
                    <h1 id="h1film" class="flex justify-center py-5 lg:px-20 md:px-10 px-5 lg:mx-40 md:mx-20 mx-5 font-bold text-4xl text-gray-800 " >Cambio de fondo</h1>
