<x-app-layout>
    ...
    <div class="flex flex-col ">
        <img class="opacity-80 w-screen h-screen " style="z-index:1" id="imagenStyle" src="http://i.annihil.us/u/prod/marvel/i/mg/5/a0/538615ca33ab0.jpg"/>
    ...
    <div class="bg-white mt-52 bg-customHeader">
