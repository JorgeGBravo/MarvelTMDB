            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img  src="{{asset("storage/MARVEL & The Movie db-grey.png")}}" class="block h-10 w-auto fill-current text-gray-600" />
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:justify-items-stretch sm:ml-6">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        ...
                        <button class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out" href="route('logout')">
